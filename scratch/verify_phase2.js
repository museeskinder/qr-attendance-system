...
async function runVerification() {
  ...
  res = await fetch(`${api}/auth/register`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ name: 'Lock Test', email: lockEmail, password: 'password123', role: 'student', department_id: 1, courses: [1] })
  });
  ...
  console.log('\n👉 3. Registering student with Department & Courses...');
  res = await fetch(`${api}/auth/register`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
